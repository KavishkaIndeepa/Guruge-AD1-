...
public class ManageEmployeeFormController implements Initializable {
    ...
    private static ManageEmployeeFormController Ad;
    public ManageEmployeeFormController(){
        Ad = this;
    }
    public static ManageEmployeeFormController getAd(){
        return Ad;
    }
...
EmployeeBO employeeBO  = (EmployeeBO) BOFactory.getBoFactory().getBo(BOFactory.BOType.EMPLOYEE);
    ...
    public void updateOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
       ...
       EmployeeDTO employee =new EmployeeDTO(nic,name,address,mobilNo,userName,password);
    ...
    public void deleteOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        boolean isDelete=employeeBO.deleteEmployee(txtNic.getText());
    ...
    public void saveOnAction(ActionEvent actionEvent) {
        ...
        EmployeeDTO employee =new EmployeeDTO(nic,name,address,mobileNo,userName,password);
        try {
            boolean isAdded = employeeBO.saveEmployee(employee);

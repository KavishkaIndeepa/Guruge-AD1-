...
import lk.ijse.riceMil.bo.custom.impl.PlaceOrderBOImpl;
...
public class PlaceOrderFormController implements Initializable {
    ...
    private static PlaceOrderFormController Ad;

    public PlaceOrderFormController() {
        Ad = this;
    }

    public static PlaceOrderFormController getAd() {
        return Ad;
    }
...
//    CustomerBO customerBO = new CustomerBOImpl();
    ...
    public void cmbItemOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            ItemDTO item = itemBO.searchItems(code);
            fillItemFields(item);
            txtQty.requestFocus();
    ...
    public void btnPlaceOrderOnAction(ActionEvent actionEvent) {
        ...
        ArrayList<CartDetailDTO> cartDetails = new ArrayList<>();
        ...
        for (int i = 0; i < tblOrderCart.getItems().size(); i++) {
            ...
            cartDetails.add(new CartDetailDTO(orderId, tm.getCode(), tm.getDescription(), tm.getUnitePrice(), LocalDate.now().
                    toString(), tm.getQty()));
        ...
        PlaceOrderDTO placeOrder = new PlaceOrderDTO(customerNic, orderId, cartDetails);

        try {
            // System.out.println(placeOrder.getOrderId());
            placeOrderBO.placeOrderForm(placeOrder, this);
//            if (isPlaced) {
//                /* to clear table */
//                obList.clear();
//                loadNextOrderId();
...
//            }
    ...
    private void fillItemFields(CustomerDTO customer) {
    ...
    public void loadCustomerNic() {
        try {
            ...
            ArrayList<String> nicList = customerBO.loadCustomerNic();
